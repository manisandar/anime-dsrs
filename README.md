...
│ 2. Content-Based Filtering     │ 29-Genre Cosine Similarity & Preference Profile│
│ 3. Knowledge-Based Recommender │ Multi-attribute Constraints & Mood Rules      │
│ 4. 1+1 Hybrid Recommender      │ 50% CBF Taste + 50% KBR Requirements Fusion   │
└────────────────────────────────┴───────────────────────────────────────────────┘
```
...
### 4. 1+1 Hybrid Recommendation: "Smart Match"
